...
namespace com.lampica.docs{
    ...
    public class TimescaleHelper
    {
        ...
        //
        public TimescaleHelper(string host= "timescaledb-azure", string user="postgres",
        ...
        public void RunQueryExample(){
            ...
            {
                using(NpgsqlDataReader rdr = cmd.ExecuteReader()) {
                    while (rdr.Read()) Console.WriteLine($"{rdr.GetDouble(0)} - {rdr.GetDouble(2)}");
                }
            }
